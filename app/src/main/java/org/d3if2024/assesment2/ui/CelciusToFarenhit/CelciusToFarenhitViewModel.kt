...
//        val hasilConverCelcius = "Farenhit"/
        ...
        fun getKategoriLabel(kategori: KategoriSuhu): Int {
            val stringRes = when (kategori) {
                KategoriSuhu.FARENHIT-> R.string.farenhit
                KategoriSuhu.REAMUR -> R.string.reamur
                KategoriSuhu.KELVIN -> R.string.kelvin
            }
            return stringRes
        }
